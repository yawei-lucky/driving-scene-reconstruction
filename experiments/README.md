...
- `stage_h3_tbv_three_tile_drive.md`: frozen checkpoint-data views, tile-4
  2,000/8,000-step reconstruction, second real seam, and the 260 m three-tile
  kinematic simulated-driver video and coverage decision.
